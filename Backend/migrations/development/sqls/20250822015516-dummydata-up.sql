...
VALUES ("Bob", "Smith", "bobsmith@email.com");
...
INSERT INTO businesses (operator_user_id, name, tagline, contact_name, contact_phone_no, contact_email, description)
VALUES (3, "BS Industries", "BS is the BeSt", "Bob Smith", "0123456789", "bobsmith@email.com", "We make things!!");


INSERT INTO users (first_name, last_name, contact_email)
VALUES ("Alice", "Smith", "alicesmith@email.com");

INSERT INTO user_logins (user_id, login_email, password_hash)
VALUES (4, "alicesmith@email.com", "$argon2id$v=19$m=16,t=2,p=1$ZnNWV1d2NmhEcHdqS1dnVQ$3BS7qPg660+dTHHM7KwbmA");

INSERT INTO businesses (operator_user_id, name, tagline, contact_name, contact_phone_no, contact_email, description)
VALUES (4, "A-Team", "AT our best", "Alice Smith", "0123456789", "alicesmith@email.com", "We make things!!");


INSERT INTO users (first_name, last_name, contact_email)
VALUES ("Steve", "Smith", "stevesmith@email.com");

INSERT INTO user_logins (user_id, login_email, password_hash)
VALUES (5, "stevesmith@email.com", "$argon2id$v=19$m=16,t=2,p=1$ZnNWV1d2NmhEcHdqS1dnVQ$3BS7qPg660+dTHHM7KwbmA");

INSERT INTO businesses (operator_user_id, name, tagline, contact_name, contact_phone_no, contact_email, description)
VALUES (5, "Steve's Lava Chicken", "It's tasty as hell!", "Steve", "0123456789", "stevesmith@email.com", "It's a lava attack!");
